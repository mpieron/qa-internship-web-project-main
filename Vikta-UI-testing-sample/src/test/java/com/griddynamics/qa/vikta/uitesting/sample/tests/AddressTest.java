...
public class AddressTest extends BaseTest {
  ...
  @BeforeMethod(onlyForGroups = "needAddress")
  ...
  //    Looks like first address is also generated each time, same part is nickname - To4ka
  @Test
  public void checkThatFirstAddressNicknameIsCorrect() {
    //        Click at Addresses tab
    addressSteps.clickAtAddressesTab();

    //        Verify default address is correct
    addressSteps.verifyFirstAddressNicknameIsCorrect();
  }
